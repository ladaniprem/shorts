    ...
    return (
        <div className="flex min-h-screen bg-[#050505]">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-between p-12 border-right border-white/5">
                ...
                <div className="relative z-10 max-w-md">
                    <h1 className="text-5xl font-bold text-white mb-6 leading-tight">
                        Transform Ideas into <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400">Viral Content</span>
                    </h1>
                    <p className="text-neutral-400 text-lg">
                        The world's most powerful AI shorts engine. Join 10,000+ creators building their future.
                    </p>
                </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
                <div className="absolute inset-0 lg:hidden bg-gradient-to-br from-purple-900/10 via-black to-blue-900/10" />
